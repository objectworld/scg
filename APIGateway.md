...
- [1. API 게이트웨이](#1-api------)
  ...
  * [1.2. **API 게이트웨이의 주요 기능**](#12---api---------------)
    ...
    + [1.2.3. **API 라우팅**](#123---api------)
      - [1.2.4.1. **백엔드 API 서버로의 로드 밸런싱**](#1241-------api--------------)
      - [1.2.4.2. **서비스 및 클라이언트 별 엔드포인트 제공**](#1242---------------------------)
      - [1.2.4.3. **메세지 또는 헤더기반 라우팅**](#1243--------------------)
    + [1.2.5. **공통 로직 처리**](#125-------------)
    + [1.2.6. **메디에이션 기능 (Mediation)**](#126-------------mediation---)
      - [**1.2.6.1. 메세지 포맷 변환 (Message format transformation)**](#--1261------------message-format-transformation---)
      - [**1.2.6.2. 프로토콜 변환**](#--1262----------)
    + [1.2.7. **메세지 호출 패턴 변환 (Message Exchange Pattern : MEP)**](#127-----------------message-exchange-pattern---mep---)
    + [1.2.8. **어그레게이션 (aggregation)**](#128-----------aggregation---)
    + [**1.2.9. 로깅 및 미터링**](#--129-----------)
      - [**1.2.9.1 API 호출 로깅**](#--1291-api--------)
      - [**1.2.9.2. API 미터링 & 차징 (Metering & Charing)**](#--1292-api-----------metering---charing---)
      - [**1.2.9.3. QoS 조정 (Quality of service)**](#--1293-qos-----quality-of-service---)
...
#### 1.2.4.2. **서비스 및 클라이언트 별 엔드포인트 제공**
...
### 1.2.7. **메세지 호출 패턴 변환 (Message Exchange Pattern : MEP)**
...
#### **1.2.9.2. API 미터링 & 차징 (Metering & Charing)**	
...
#### **1.2.9.3. QoS 조정 (Quality of service)**
